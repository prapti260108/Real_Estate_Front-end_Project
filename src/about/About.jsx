...
const API_BASE_URL = "https://real-estate-back-end-project-2.onrender.com/api"
      ...
      try {
        ...
        if (teamResponse.ok) {
          ...
          const makeImgUrl = (img) => {
            ...
            if (img.includes("uploads") || img.startsWith("/")) return `https://real-estate-back-end-project-2.onrender.com/${img.replace(/^\//, "")}`
            return `https://real-estate-back-end-project-2.onrender.com/uploads/${img}`
          }
