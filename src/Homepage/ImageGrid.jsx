  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const mainImageResponse = await fetch("https://real-estate-back-end-project-2.onrender.com/api/image");
        ...
        // Fetch grid images
        const gridResponse = await fetch("https://real-estate-back-end-project-2.onrender.com/api/image");
        if (!gridResponse.ok) {
